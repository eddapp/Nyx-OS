...
NYX_PACKAGES=(nyx-health nyx-vpn nyx-identity nyx-devices nyx-dns nyx-integrity nyx-wipe nyx-isolation nyx-workflow nyx-thunar-integration nyx-dashboard)
