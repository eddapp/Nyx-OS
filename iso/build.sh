...
NYX_PACKAGES=(nyx-health nyx-vpn nyx-identity nyx-devices nyx-telemetry nyx-diagnostics nyx-dns nyx-integrity nyx-wipe nyx-isolation nyx-workflow nyx-hardening nyx-watch nyx-thunar-integration nyx-desktop-sessions nyx-dashboard nyx-browsers)
